...
def main():
    ...
    # stanza.download('en', model_dir='./leamr_stanza_resources')
    # print("EXIT")
    # sys.exit(0)
    ...
    # filename = amr_file
    with open(amr_file + '.lemmas.json', 'w+', encoding='utf8') as f:
        json.dump(lemmas_json, f)
    with open(amr_file + '.pos.json', 'w+', encoding='utf8') as f:
        json.dump(pos_json, f)
    with open(amr_file + '.spans.json', 'w+', encoding='utf8') as f:
        json.dump(multi_word_spans, f)
    if coreferences:
        with open(amr_file + '.coref.json', 'w+', encoding='utf8') as f:
