...
def main():
    ...
    align_file = unaligned_amr_file + f'.subgraph_alignments.json'
    ...
    align_file = unaligned_amr_file+ f'.relation_alignments.json'
    ...
    align_file = unaligned_amr_file + f'.reentrancy_alignments.json'
